...
CREATE TABLE DISPONIBILIDAD (
    ...
    cedula_conductor NUMBER(10) NOT NULL,
    ...
    CONSTRAINT fk_disponibilidad_conductor FOREIGN KEY (cedula_conductor) REFERENCES USUARIO(cedula),
    CONSTRAINT chk_disponibilidad_estado CHECK (estado IN ('DISPONIBLE', 'ENSERVICIO')),
    CONSTRAINT fk_disp_vehiculo FOREIGN KEY (placa_vehiculo) REFERENCES VEHICULO(placa)
);
